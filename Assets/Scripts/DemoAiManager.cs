...
{ 
    ...
    private void Start()
    {
        if (MyPlayerNumber == 1)
        {
            if (board.GetComponent<DemoBoardManager>().PlayerSlot[0] == "easyai")
            {
                isThisAiEasy = true;
                isThisAiMedium = false;
                isThisAiHard = false;
            }
            else if (board.GetComponent<DemoBoardManager>().PlayerSlot[0] == "medai")
            {
                isThisAiEasy = false;
                isThisAiMedium = true;
                isThisAiHard = false;
            }
            else if (board.GetComponent<DemoBoardManager>().PlayerSlot[0] == "hardai")
            {
                isThisAiEasy = false;
                isThisAiMedium = false;
                isThisAiHard = true;
        ...
        {
            if (board.GetComponent<DemoBoardManager>().PlayerSlot[1] == "easyai")
            {
                isThisAiEasy = true;
                isThisAiMedium = false;
                isThisAiHard = false;
            }
            else if (board.GetComponent<DemoBoardManager>().PlayerSlot[1] == "medai")
            {
                isThisAiEasy = false;
                isThisAiMedium = true;
                isThisAiHard = false;
            }
            else if (board.GetComponent<DemoBoardManager>().PlayerSlot[1] == "hardai")
            {
                isThisAiEasy = false;
                isThisAiMedium = false;
                isThisAiHard = true;
        ...
        {
            if (board.GetComponent<DemoBoardManager>().PlayerSlot[2] == "easyai")
            {
                isThisAiEasy = true;
                isThisAiMedium = false;
                isThisAiHard = false;
            }
            else if (board.GetComponent<DemoBoardManager>().PlayerSlot[2] == "medai")
            {
                isThisAiEasy = false;
                isThisAiMedium = true;
                isThisAiHard = false;
            }
            else if (board.GetComponent<DemoBoardManager>().PlayerSlot[2] == "hardai")
            {
                isThisAiEasy = false;
                isThisAiMedium = false;
                isThisAiHard = true;
        ...
        {
            if (board.GetComponent<DemoBoardManager>().PlayerSlot[3] == "easyai")
            {
                isThisAiEasy = true;
                isThisAiMedium = false;
                isThisAiHard = false;
            }
            else if (board.GetComponent<DemoBoardManager>().PlayerSlot[3] == "medai")
            {
                isThisAiEasy = false;
                isThisAiMedium = true;
                isThisAiHard = false;
            }
            else if (board.GetComponent<DemoBoardManager>().PlayerSlot[3] == "hardai")
            {
                isThisAiEasy = false;
                isThisAiMedium = false;
                isThisAiHard = true;
    ...
    void Update()
    {
        CurrentPlayer = board.GetComponent<DemoBoardManager>().currentPlayer;
        TurnCounter = board.GetComponent<DemoBoardManager>().TurnCounter;


        if (CurrentPlayer == MyPlayerNumber && running == false && TurnTaken == false && board.GetComponent<DemoBoardManager>().Endgame == false)
        {
            //board.GetComponent<DemoBoardManager>().IsAiTurn = true;
            SquareCheck();
    ...
    private void SquareCheck()
    {
        ...
        foreach (GameObject square in board.GetComponent<DemoBoardManager>().Squares)
        {
    ...
    {
        ChosenSquare = null;
        if (isThisAiEasy == true)//board.GetComponent<DemoBoardManager>().IsAiHard == false) //Standard level ai, has a chance to miss a claimable square and a chance to give them away
        {
            ...
            else
            {
                if (UnclaimedSquares2Lines.Count != 0) //Gathering the lines in dangerous 2 lines taken squares
                {
                    foreach (GameObject dangersquare in UnclaimedSquares2Lines)
                    {
                        ...
                        //Horizontal lines
                        foreach (GameObject line in board.GetComponent<DemoBoardManager>().Lines)
                        {
    ...
    private void TakeTurn()
    {
        if (ChosenLine != null)
        {
            ...
            {
                board.GetComponent<DemoBoardManager>().MouseTarget = ChosenLine;
                //ChosenLine.GetComponent<Line>().isClicked = true;
                //ChosenLine.GetComponent<MeshRenderer>().material = board.GetComponent<DemoBoardManager>().selectedMat;
                //board.GetComponent<DemoBoardManager>().IsAiTurn = false;
                //board.GetComponent<DemoBoardManager>().currentPlayer += 1;
    ...
    private void Delay()
    {
        if (isThisAiEasy == true)//board.GetComponent<DemoBoardManager>().IsAiHard == false)
        {
